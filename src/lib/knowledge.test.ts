...
test("retrieval returns only the active current version for the requested tenant", () => {
  const database = { tenants: [], users: [], auditLogs: [], conversations: [], conversationMessages: [], conversationFeedback: [], sopDefinitions: [], sopExecutions: [], ticketingIntegrations: [], tickets: [], ticketSyncLogs: [], knowledgeDocuments: [document("active", "tenant-a", "ACTIVE", "v-active"), document("draft", "tenant-a", "DRAFT", null), document("archived", "tenant-a", "ARCHIVED", "v-archived"), document("other-tenant", "tenant-b", "ACTIVE", "v-other")], knowledgeVersions: [version("v-active", "active", "tenant-a", "ACTIVE", "Reset the hydraulic pressure alarm safely."), version("v-old", "active", "tenant-a", "ARCHIVED", "Obsolete hydraulic instructions."), version("v-draft", "draft", "tenant-a", "DRAFT", "Unapproved hydraulic instructions."), version("v-archived", "archived", "tenant-a", "ARCHIVED", "Archived hydraulic instructions."), version("v-other", "other-tenant", "tenant-b", "ACTIVE", "Another tenant hydraulic instructions.")] } satisfies Database;
