...
function normalize(database: Database): Database { database.tenants??=[]; database.users??=[]; database.auditLogs??=[]; database.conversations??=[]; database.conversationMessages??=[]; database.conversationFeedback??=[]; database.knowledgeDocuments??=[]; database.knowledgeVersions??=[]; database.knowledgeGaps??=[]; database.rateLimits??=[]; database.sopDefinitions??=[]; database.sopExecutions??=[]; database.ticketingIntegrations??=[]; database.tickets??=[]; database.ticketSyncLogs??=[]; return database; }
