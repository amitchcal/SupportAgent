...
export function seedDatabase(): Database {
  ...
  return {
    ...
    users: [],
    auditLogs: [], conversations: [], conversationMessages: [], conversationFeedback: [], knowledgeDocuments: [], knowledgeVersions: [], knowledgeGaps: [], knowledgeCandidates: [], industryTemplates: [], rateLimits: [], messagingReceipts: [], sopDefinitions: [], sopExecutions: [], ticketingIntegrations: [], tickets: [], ticketSyncLogs: [],
  };
}
...
async function load(): Promise<Database> {
  ...
  try {
    ...
    database.conversations ??= []; database.conversationMessages ??= []; database.conversationFeedback ??= []; database.knowledgeDocuments ??= []; database.knowledgeVersions ??= []; database.knowledgeGaps ??= []; database.knowledgeCandidates ??= []; database.industryTemplates ??= []; database.rateLimits ??= []; database.messagingReceipts ??= []; database.sopDefinitions ??= []; database.sopExecutions ??= []; database.ticketingIntegrations ??= []; database.tickets ??= []; database.ticketSyncLogs ??= [];
    return database;
  } catch (error) {
