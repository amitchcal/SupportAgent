...
export function seedDatabase(): Database {
  ...
  return {
    ...
    users: [],
    auditLogs: [], conversations: [], conversationMessages: [], conversationFeedback: [], knowledgeDocuments: [], knowledgeVersions: [], knowledgeGaps: [], knowledgeCandidates: [], industryTemplates: [], rateLimits: [], sopDefinitions: [], sopExecutions: [], ticketingIntegrations: [], tickets: [], ticketSyncLogs: [],
  };
}
